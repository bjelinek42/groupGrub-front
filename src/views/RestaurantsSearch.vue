...
<template>
  <div>
    ...
    <div v-for="restaurant in restaurants" v-bind:key="restaurant.location_id">
      ...
      <h1 v-if="restaurant.hours">Hours: Sunday: {{ restaurant.hours.week_ranges[0] }}
        ...
        Saturday: {{ restaurant.hours.week_ranges[6] }}
      </h1>
      <h1>Cuisines:</h1>
      ...
      <h2 v-if="restaurant.reserve_info">Reserve a Table:<a v-bind:href="restaurant.reserve_info.url"
          target="_blank"><img v-bind:src="restaurant.reserve_info.provider_img" v-bind:alt="None"
            style="width:300px"></a>
      </h2>
